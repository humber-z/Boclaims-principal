...
componentDidMount = () => {
 ...
 fullFields = (data) => {
  this.setState({
        ...
        fechaAutoAdmiActora1  : data.fechaAutoAdmiActora1  ? data.fechaAutoAdmiActora1.toDate() : null,
        idAAA1: data.idAAA1,
        fechaAutoAdmiDeman2  : data.fechaAutoAdmiDeman2  ? data.fechaAutoAdmiDeman2.toDate() : null,
        idAAD2: data.idAAD2,
...
handleAutoAdmitAct(date){
    if(date.getDate() == ((this.state.fechaAutoAdmiActora) ? (this.state.fechaAutoAdmiActora).getDate() : null ) ||!this.state.fechaAutoAdmiActora ){
  this.setState({fechaAutoAdmiActora: date, fechaAAA1Database: date})
    }else{
      this.setState({fechaAutoAdmiActora: date, fechaAAA1Database: date,updateAAA1: true})
    }
}
handleAutoAdmitDem(date){
  if(date.getDate() == ((this.state.fechaAutoAdmiDeman) ? (this.state.fechaAutoAdmiDeman).getDate() : null ) ||!this.state.fechaAutoAdmiDeman ){
  this.setState({fechaAutoAdmiDeman: date,  fechaAAD2Database: date})
  }else{
   this.setState({fechaAutoAdmiDeman: date,  fechaAAD2Database: date, updateAAD2: true}) 
  }
}
...
handlePresRecApel(date){
  if(date.getDate() == ((this.state.fechaPresentRecApe) ? (this.state.fechaPresentRecApe).getDate() : null ) ||!this.state.fechaPresentRecApe ){
  this.setState({fechaPresentRecApe: date, fechaPRADatabase: date})
  }else{
   this.setState({fechaPresentRecApe: date, fechaPRADatabase: date,updatePRAD: true}) 
  }
}
...
handlePresentAmp(date){
  if(date.getDate() == ((this.state.fechaPresentAmp) ? (this.state.fechaPresentAmp).getDate() : null ) ||!this.state.fechaPresentAmp ){
  this.setState({fechaPresentAmp: date, fechaPADatabase: date})
}else{
  this.setState({fechaPresentAmp: date, fechaPADatabase: date,updatePAD: true})
}}
handleEjecAmp(date){
          ...
          <div>  
            ...
            <Button variant="contained" component="span" style={{margin: '20px'}}>
              ...
              <TextField
               ...
               onChange={(e) => this.setState({coment15: e.target.value, descr:e.target.value})}
               margin="normal"
               variant="outlined"
               style={{width: '350px'}}
               />
          ...
          <div>  
            ...
            <Button variant="contained" component="span" style={{margin: '20px'}}>
              ...
              <TextField
               ...
               onChange={(e) => this.setState({coment16: e.target.value, descr:e.target.value})}
               margin="normal"
               variant="outlined"
               style={{width: '350px'}}
               />
          ...
          <div>  
            ...
            <Button variant="contained" component="span" style={{margin: '20px'}}>
              ...
              <TextField
               ...
               onChange={(e) => this.setState({coment17: e.target.value, descr:e.target.value})}
               margin="normal"
               variant="outlined"
               style={{width: '350px'}}
               />
          ...
          <div>  
            ...
            <Button variant="contained" component="span" style={{margin: '20px'}}>
              ...
              <TextField
               ...
               onChange={(e) => this.setState({coment18: e.target.value, descr:e.target.value})}
               margin="normal"
               variant="outlined"
               style={{width: '350px'}}
               />
          ...
          <div>  
            ...
            <Button variant="contained" component="span" style={{margin: '20px'}}>
              ...
              <TextField
               ...
               onChange={(e) => this.setState({coment19: e.target.value, descr:e.target.value})}
               margin="normal"
               variant="outlined"
               style={{width: '350px'}}
               />
...
save = async () =>{
    ...
    if(this.state.fechaAAA1Database){
      ...
      await firebase.firestore().collection('fechas').doc(this.state.idAAA1).update({
            text: `Caso ${this.props.selectedNote.title} Fecha de Auto que permite Pruebas de Actora(Desahogo)`,
        fecha: this.state.fechaAAA1Database,
        timestamp: firebase.firestore.FieldValue.serverTimestamp()
        });
    }else{
     const idAAA1 = await firebase.firestore()
       .collection('fechas')
       .add({
        text: `Caso ${this.props.selectedNote.title} Fecha de Auto que permite Pruebas de Actora(Desahogo)`,
        fecha: this.state.fechaAAA1Database,
    ...
    if(this.state.fechaAAD2Database){
     ...
     await firebase.firestore().collection('fechas').doc(this.state.idAAD2).update({
         text: `Caso ${this.props.selectedNote.title} Fecha de Auto que permite Pruebas de Demanda(Desahogo)`,
        fecha: this.state.fechaAAD2Database,
        timestamp: firebase.firestore.FieldValue.serverTimestamp()
        });
    }else{
       const idAAD2 =  await firebase.firestore()
       .collection('fechas')
       .add({
        text: `Caso ${this.props.selectedNote.title} Fecha de Auto que permite Pruebas de Demanda(Desahogo)`,
        fecha: this.state.fechaAAD2Database,
    ...
    this.setState({idAAD2: idAAD2.id})
     ...
     if(this.state.fechaPRADatabase){
      ...
      await firebase.firestore().collection('fechas').doc(this.state.idPRAD).update({
        text: `Caso ${this.props.selectedNote.title} Fecha de Presentacion de Recursos de Apelacion`,
        fecha: this.state.fechaPRADatabase,
        timestamp: firebase.firestore.FieldValue.serverTimestamp()
        });
   }else{
     const idPRAD = await firebase.firestore()
       .collection('fechas')
       .add({
        text: `Caso ${this.props.selectedNote.title} Fecha de Presentacion de Recursos de Apelacion`,
        fecha: this.state.fechaPRADatabase,
